...
# Stars Monitor Notifications

This is the second chapter of the [stars monitor blog](https://github.com/triggerdotdev/blog/tree/main/stars-monitor)
This is a demo for creating a GitHub stars monitor notifications

- Create a generic function for sending notifications
- Add the jobs to do so
- Show different implementations for different notification services
