  ...
  run: async (payload, io, ctx) => {
    ...
    const assistant = await io.openai.runTask("create-or-update-assistant", async (openai) => {
        ...
        return openai.beta.assistants.create({
            ...
            instructions: `You are a content writer assistant, you have been loaded with documentation from ${payload.url}, you write blog posts based on the documentation, return everything in the following MD format:
---
slug: [post-slug]
title: [post-title]
---
